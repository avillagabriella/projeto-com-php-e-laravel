...
@section('content')
    ...
    <form action="{{ route('admin.users.store') }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Avilla Gabriella" required>
        </div>
        @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="avilla@outlook.com" required>
        </div>
        @error('email')
        <div class="alert alert-danger">
            <ul>
