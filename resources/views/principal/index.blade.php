        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="main-navbar">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{ route('index') }}">Página inicial</a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style="background:#b38a4d;">

                            <a class="dropdown-item {{ Request::is('me*') ? 'active' : '' }}" href="{{ route('admin.users.index') }}">
                                Meus dados
                            </a>
        ...
        <div class="d-flex flex-nowrap min-vh-100">
            <div class="my-5 flex-grow-1">
                <div class="container-sm bg-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <img width="100%" src="/images/imgm.png">
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <a href="{{ route('front.produto', $merchandise->id ) }}" style="text-decoration: none;color:#333">
                                    <div class="col-md-12">
                                        <div>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <h4 style="font-weight: bold;">{{ $merchandise->name }}</h4>
                                    </div>
                                    <div class="col-md-12">
                                        <h5>R$ {{ number_format($merchandise->sale_price,2,",",".")  }}</h5>
                                    </div>
