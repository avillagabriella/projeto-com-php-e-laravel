...
<body>
    <div class="w-100 bg-light">
        <div class="d-flex flex-nowrap min-vh-100">
            <!-- Sidebar-->
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 180px; background: #b38a4d !important;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="{{ route('admin.categories.index') }}" class="nav-link {{ Request::is('admin/categories*') ? 'active' : 'text-white' }}">
                            Categorias
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.merchandises.index') }}" class="nav-link {{ Request::is('admin/merchandises*') ? 'active' : 'text-white' }}">
                            Mercadorias
                        </a>
                    </li>
                    <li>
